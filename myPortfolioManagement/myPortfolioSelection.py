...
def all_combinations_inner_loop(min_num_of_funds: int, max_num_of_funds: int, assets_to_consider: list):
    """
...
@timebudget
def possible_combinations(assets_to_consider: list, min_assets=3, max_assets=20, must_have=[]):
    ...
    # get combinations
    all_combinations = all_combinations_inner_loop(min_assets, max_assets, assets_to_consider)
    ...
    if must_have:
        ...
        all_portf = [x for x in all_portf if set(x) & must_have_set == must_have_set]
