...
from myPortfolioManagement.myReturns import download_stock_returns, get_multi_asset_returns
...
bench1 = download_stock_returns(['^IXIC'])
bench2 = download_stock_returns(['^GSPC'])

stock = download_stock_returns(['SMT.L'])
...
port = get_multi_asset_returns()
bench = download_stock_returns(['^IXIC'])
bench2 = download_stock_returns(['^GSPC'])
stock = download_stock_returns(['SMT.L'])
stock = stock[stock.index >= '2005']
