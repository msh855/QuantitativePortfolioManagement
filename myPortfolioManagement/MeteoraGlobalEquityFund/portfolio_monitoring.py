...
from myPortfolioManagement.myPerformanceMetrics import performance_overview, get_main_stats, reward_metric
...
get_main_stats(df_prices).sort_values('cagr', ascending=False)
