...
# smooth
prices = prices_temp.ewm(span=1825).mean()
...
df_rank_norm['ranking'] = df_rank_norm.fillna(0).dot(weights_for_ranking)
...
df_portfolios.columns = [x + '_sm' for x in df_portfolios.columns]
