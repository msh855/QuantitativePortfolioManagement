...
def metrics(returns: _pd.DataFrame, benchmark: _pd.DataFrame = None, rf: float = 0,
    ...
    Args:
        returns (_pd.DataFrame): DESCRIPTION.
        benchmark (_pd.DataFrame, optional): DESCRIPTION. Defaults to None.
        rf (float, optional): DESCRIPTION. Defaults to 0.
        display (bool, optional): DESCRIPTION. Defaults to False.
        mode (str, optional): DESCRIPTION. Defaults to 'basic'.
        sep (bool, optional): DESCRIPTION. Defaults to False.
        compounded (bool, optional): DESCRIPTION. Defaults to True.
        periods_per_year (int, optional): DESCRIPTION. Defaults to 252.
        prepare_returns (bool, optional): DESCRIPTION. Defaults to True.
        match_dates (bool, optional): DESCRIPTION. Defaults to False.
